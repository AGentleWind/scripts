...
// 农妇山泉 -> 有点咸
// 本脚本用作曲线双签到,结合APP:py3使用
// 1、登陆要阅读的账号一、二、三.....,理论无限
// 2、Surge抓包记录找到 `https://apiwz.midukanshu.com/wz/dice/index?` 该记录标记收藏
// 3、从收藏记录中选择该记录导出,使用pythonista3运行midu.py
// 4、在Surge->脚本->新增, 脚本名:自定义不要重复就好, 脚本类型选择Cron, cron表达式: 0 1 * * * *  脚本位置->本地
// 5、编辑脚本:贴贴py3的结果,换行然后复制本脚本内容->保存
const cookieName = '米读'

const senku = init()

const signurlVal = 'https://apiwz.midukanshu.com/wz/task/signInV2?' + body
const signVideourlVal = 'https://apiwz.midukanshu.com/wz/task/signVideoReward?' + body
const dice_index_urlVal = 'https://apiwz.midukanshu.com/wz/dice/index?' + body
const dice_roll_urlVal = 'https://apiwz.midukanshu.com/wz/dice/roll?' + body
const dice_double_urlVal = 'https://apiwz.midukanshu.com/wz/dice/doubleReward?' + body
const dice_addnum_urlVal = 'https://apiwz.midukanshu.com/wz/dice/addChangeNumByRewardVideo?' + body
const signinfo = {
    addnumList: [],
    rollList: [],
    doubleList: []
